...
public class CustomAnimatorDriver : MonoBehaviour
{
	...
	public int 									bvhPort = 7001;									// Axis Neuron BVH port
    public int                                  calcPort = 7003;                                // Axis Neuron Calc port
	...
	void OnEnable()
	{
		...
		source = NeuronConnection.Connect( address, bvhPort, calcPort, commandServerPort, socketType );
